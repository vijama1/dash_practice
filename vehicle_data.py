#defining all the necessary imports
import pandas as pd
...
#creating a dictionary for the datapoints we intend to cover
...
#generating the sample data to ploy
...
#defining the decorator for input,output and event
@app.callback(
